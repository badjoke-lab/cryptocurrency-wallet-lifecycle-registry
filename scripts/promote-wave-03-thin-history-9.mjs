...
const candidate=JSON.parse(fs.readFileSync('data-staging/candidates/coverage-recovery-wave-03-thin-history-9.json','utf8'));
...
const targets=[
 ['wlr_ent_000100','Prokey','wlr_prod_000149','Prokey Optimum'],
 ['wlr_ent_000033','Guarda Wallet','wlr_prod_000082','Guarda Wallet'],
 ['wlr_ent_000037','OneKey','wlr_prod_000086','OneKey Pro'],
 ['wlr_ent_000040','NGRAVE','wlr_prod_000089','NGRAVE ZERO'],
 ['wlr_ent_000045','Ronin Wallet','wlr_prod_000094','Ronin Wallet Extension']
];
