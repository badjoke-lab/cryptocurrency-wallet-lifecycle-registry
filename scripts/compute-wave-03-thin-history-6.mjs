...
const out = {
  generated_from_main_sha: '688fd756d3752d992992aa46dee3a525414516b8',
...
fs.writeFileSync('data-staging/coverage/coverage-recovery-wave-03-thin-history-6.json', `${JSON.stringify(out, null, 2)}\n`);
